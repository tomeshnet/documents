...
1. Install Synapse homeserver version [v0.18.5](https://github.com/matrix-org/synapse/releases/tag/v0.18.5):

	```
	# virtualenv -p python2.7 ~/.synapse
	# source ~/.synapse/bin/activate
	# pip install --upgrade setuptools
	# pip install https://github.com/matrix-org/synapse/tarball/v0.18.5
	```
